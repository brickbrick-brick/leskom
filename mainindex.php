            ...
            <div id="openModal" class="modal">
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-label">вход</div>
                    <div class="modal-body">    
                        <form method="post" action="login.php">
                            ...
                            <p class="coloracc">
                                Нет аккаунта?<a href="#openModal" class="colorreg" href="register.php">Зарегистрироваться</a>
                            </p>
                        </form>
                    </div>
                  </div>
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">    
                        ...
                        <form method="post" action="register.php">
                            ...
                            <p class="coloracc-2">
                                Уже зарегистрированы?<a href="#openReg" class="colorreg" href="login.php">Войти</a>
                            </p>
                        </form>
                    </div>
                  </div>
